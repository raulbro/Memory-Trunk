...
class ExamplesControllerTest < ActionController::TestCase
  ...
  test "should create example" do
    assert_difference('Example.count') do
      post :create, example: { Created_at: @example.Created_at, body: @example.body, comment: @example.comment, title: @example.title }
    end
  ...
  test "should update example" do
    patch :update, id: @example, example: { Created_at: @example.Created_at, body: @example.body, comment: @example.comment, title: @example.title }
    assert_redirected_to example_path(assigns(:example))
  end
